...
local Window = OrionLib:MakeWindow({Name = "筷子中心", HidePremium = false, SaveConfig =true,IntroText="加载脚本", ConfigFolder = "文件存放名"})
...
Tab:AddParagraph("作者，内个")
Tab:AddParagraph("我直接我拿那个筷子")
Tab:AddParagraph("帮助者 鑫晴")
Tab:AddParagraph("都给我支持少羽懂不懂")


Tab:AddButton ({
	Name = "复制作者qq",
	Callback = function ()
	 setclipboard("1061727971")
	 OrionLib:MakeNotification({
                    Name = "信息",
                    Content = "复制请在粘贴板中查看",
                    Time = 2
